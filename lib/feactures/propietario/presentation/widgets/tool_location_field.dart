...
class ToolLocationField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasLocation = latitude != null && longitude != null && latitude != 0.0;
      ...
      children: [
        ...
        Card(
          ...
          child: ListTile(
            ...
            title: Text(
              hasLocation ? 'Ubicación seleccionada' : 'Ubicación no establecida',
            ...
            subtitle: Text(
              ...
              style: TextStyle(fontSize: 12, color: hasLocation ? const Color(0xFF16A34A) : cs.onSurfaceVariant),
            ),
            trailing: ElevatedButton(
              ...
              onPressed: () async {
                final LatLng? res = await showDialog<LatLng>(
                  context: context,
                  builder: (_) => LocationPickerModal(initialLat: latitude, initialLng: longitude),
                );
