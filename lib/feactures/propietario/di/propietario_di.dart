import '../data/datasoruce/tool_remote_datasource.dart';
...
class PropietarioDI {
  ...
  static ExtractTicketPriceUseCase provideExtractTicketPrice() =>
      ExtractTicketPriceUseCase(_repository);
  ...
  static GetInsurancePreferenceUseCase provideGetInsurancePreference() =>
